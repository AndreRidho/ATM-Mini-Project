...
/**
 * Servlet implementation class DeductMoneyServlet
 */
public class DeductMoneyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeductMoneyServlet() {
        super();
...
//		System.out.println(reader.readLine());
		...
		for (int i=0 ; i<=10 ; i++) {
			...
			if(line.startsWith("java") || line.startsWith("ERROR")) {
				response.getWriter().append(fullOutput);
				return;
			}
		}
		...
		writer.write(request.getParameter("amount") + "\n");
		writer.flush();
		fullOutput = "";
		
		System.out.println(fullOutput += (reader.readLine() + "\n"));		
		System.out.println(fullOutput += reader.readLine());
